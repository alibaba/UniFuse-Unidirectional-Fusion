...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_input_images=1, zero_init_residual=False,
        ...
        self.conv1 = nn.Conv2d(3*num_input_images, self.inplanes, kernel_size=7, stride=2, padding=3,
...
def _resnet(arch, block, layers, pretrained, progress, num_input_images=1, **kwargs):
